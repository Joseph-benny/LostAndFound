...
<div class="container my-4">
  <h2 class="section-title"><i class="fa fa-times-circle me-2"></i>Rejected Claims</h2>
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <h6 class="text-danger">Claimer (Receiver)</h6>
          ...
          <span class="btn btn-danger mt-3"><?= ucfirst(htmlspecialchars($row['claim_status'])) ?></span>
        </div>
      </div>
    <?php endwhile; ?>
  <?php else: ?>
    <div class="alert alert-info text-center">No rejected claims found.</div>
  <?php endif; ?>
