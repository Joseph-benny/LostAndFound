...
<div class="container my-4">
  <h2 class="section-title"><i class="fa fa-check-circle me-2"></i>Approved Claims</h2>
      ...
      <div class="card shadow-lg mb-4">
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <h6 class="text-success">Claimer's Claim</h6>
          ...
          <span class="btn btn-success mt-3"><?= ucfirst(htmlspecialchars($row['claim_status'])) ?></span>
        </div>
      </div>
    <?php endwhile; ?>
  <?php else: ?>
    <div class="alert alert-info text-center">No approved claims found.</div>
  <?php endif; ?>
