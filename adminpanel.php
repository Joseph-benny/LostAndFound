...
<div class="container mt-5">
  ...
  <ul class="dropdown-menu" aria-labelledby="claimsDropdown">
    <li><a class="dropdown-item" href="pending.php">Pending Claims</a></li>
    <li><a class="dropdown-item" href="approved.php">Approved Claims</a></li>
    <li><a class="dropdown-item" href="rejected.php">Rejected Claims</a></li>
  </ul>
</div>
