...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-lg-7">
      <div class="card shadow-lg mt-5 mb-5 p-4">
        <div class="card-body">
          <h2 class="section-title"><i class="fa fa-exclamation-circle me-2"></i>Report Lost Item</h2>
          <form action="lost_process.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
              <label for="lost_item" class="form-label">Item Name</label>
              <input type="text" class="form-control" id="lost_item" name="lost_item" required>
            </div>
            <div class="mb-3">
  ...
  <textarea class="form-control" id="description" name="description" rows="4" 
    placeholder="Enter your description here.Max of 60 words." required></textarea>
  <small id="wordCount" class="text-muted">0 / 60 words</small>
</div>
...
<script>
  ...
  description.addEventListener("input", function () {
    ...
    wordCount.textContent = count + " / " + maxWords + " words";
            ...
            <button type="submit" class="btn btn-report w-100 mt-3"><i class="fa fa-paper-plane me-1"></i>Submit Report</button>
          </form>
        </div>
      </div>
    </div>
